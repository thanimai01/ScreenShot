...
async def start(c, m, cb=False):
    ...
    username = 'sarbudeen786'
    mention = '[sarbudeen786](https://t.me/sarbudeen786)'
    try:
    ...
    BUTTONS = [[
        ...
        InlineKeyboardButton("Updates Channel 🔰", url="https://t.me/Thanimaibots")
        ],[
        InlineKeyboardButton("Source code 😎", url="https://github.com/Lonelysing/SCREENSHOTBOT")
        ],[
